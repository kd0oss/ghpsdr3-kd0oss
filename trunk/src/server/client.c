                                ...
                                if (strcmp(token,"record")==0)
                                {
                                    ...
                                    if (strcmp(token,"mox")==0)
                                    {
                                        ...
                                        if (strcmp(token,"ocoutput")==0)
                                        {
                                            ...
                                            if (strcmp(token,"alexrxantenna")==0)
                                            {
                                                token=strtok(NULL," \r\n");
                                                if (token!=NULL)
                                                {
                                                ...
                                                if (strcmp(token,"alextxrelay")==0)
                                                {
                                                    ...
                                                    if (strcmp(token,"settxdrive")==0)
                                                    {
                                                        ...
                                                        if (strcmp(token,"settxlineingain")==0)
                                                        {
                                                            token=strtok(NULL," \r\n");
                                                            if (token!=NULL)
                                                            {
                                                            ...
                                                            if (strcmp(token,"hermesmicboost")==0)
                                                            {
                                                                token=strtok(NULL," \r\n");
                                                                if (token!=NULL)
                                                                {
                                                                ...
                                                                if (strcmp(token,"hermeslinein")==0)
                                                                {
                                                                    token=strtok(NULL," \r\n");
                                                                    if (token!=NULL)
                                                                    {
                                                                    ...
                                                                    if (command[0] == STARHARDWARE)
                                                                    {
                                                                        return "OK Hermes";
                                                                    }
                                                                    else
                                                                        if (strcmp(token,"getserial?")==0)
                                                                        {
                                                                            static char buf[50];
                                                                            ...
                                                                            if (strcmp(token,"getadcoverload?")==0)
                                                                            {
                                                                                static char buf[50];
                                                                                ...
                                                                                if (strcmp(token,"dither")==0)
                                                                                {
                                                                                    ...
                                                                                    if (strcmp(token,"setattenuator")==0)
                                                                                    {
                                                                                        // set attenuator
                                                                                        token=strtok(NULL," \r\n");
                                                                                        if (token!=NULL)
